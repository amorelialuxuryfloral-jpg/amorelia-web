...
/**
 * One order line on the /checkout page — SPA port. The SPA's framer-motion
 * fade-in is replaced by a CSS keyframe (SPEC §2: no framer-motion).
 */
const CheckoutOrderItem = ({ item, index, onRemove, language = "en" }: Props) => {
  const { t } = getTranslator(language);

  return (
    <div
      className="pb-6 last:pb-0 animate-fade-up"
