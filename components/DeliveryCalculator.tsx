...
/**
 * Address autocomplete + live distance/price calculator (checkout page) —
 * ported 1:1 from the SPA. Uses the `places-autocomplete` and
 * `calculate-distance` Edge Functions on the NEW Supabase project.
 * >87 mi triggers the FedEx flow via `onTooFar` (never a silent $0).
 */
