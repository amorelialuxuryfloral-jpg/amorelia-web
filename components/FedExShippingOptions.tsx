...
/**
 * FedEx national shipping selector (>87 mi) — ported 1:1 from the SPA.
 * Calls the `calculate-fedex-shipping` Edge Function (FedEx Rate API) on the
 * NEW Supabase project. Errors are explicit and user-visible; a rate is never
 * silently assumed to be 0 — checkout stays blocked until a real service is
 * picked (the parent enforces `fedexAttrs`).
 */
