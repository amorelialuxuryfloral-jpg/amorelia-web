...
/**
 * Countdown to the Mother's Day purchase window opening (SPA port). Shown
 * while the collection is "locked". Pure UX/conversion — the SEO weight lives
 * in the page content, not the timer. The ticking digits carry
 * suppressHydrationWarning (server HTML is rendered earlier than hydration).
 */
const MothersDayCountdown = ({ language }: { language: Language }) => {
        ...
        {units.map((u) => (
          ...
          >
            <span
              ...
              className="font-display text-2xl md:text-3xl font-bold text-foreground tabular-nums"
            >
