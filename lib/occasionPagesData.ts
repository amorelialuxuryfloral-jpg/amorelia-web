...
export const occasionPages: OccasionPage[] = [
  // ----------- TIER 1 (menu) -----------
  {
    ...
    title: {
      en: "Valentines Flowers Miami | Same-Day Roses Delivery | Amorelia Luxury Floral Gifts",
      es: "Flores para San Valentín Miami | Rosas a Domicilio el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
    ...
    intro: {
      en: "Looking for valentines flowers in Miami? Amorelia Luxury Floral Gifts hand-ties premium red rose bouquets the morning of February 14th and delivers them across Miami the same day. The classic move — 100 long-stem red roses in our signature box — still wins.",
      es: "¿Buscas flores para San Valentín en Miami? Amorelia Luxury Floral Gifts monta a mano bouquets premium de rosas rojas la mañana del 14 de febrero y los entrega el mismo día por todo Miami. El movimiento clásico —100 rosas rojas tallo largo en nuestra caja firma— sigue ganando.",
    },
    sections: [
      {
  ...
  },
  {
    ...
    title: {
      en: "Birthday Flowers Miami | Bright Bouquets Delivered Today | Amorelia Luxury Floral Gifts",
      es: "Flores de Cumpleaños Miami | Bouquets Vibrantes el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Christmas Flowers Miami | Red & White Holiday Roses Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Navidad Miami | Rosas Rojas y Blancas a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  // ----------- TIER 2 (footer + index) -----------
  {
    ...
    title: {
      en: "Day of the Dead Flowers Miami | Ofrenda Roses Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores para Día de Muertos Miami | Rosas para Ofrenda a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
    ...
    intro: {
      en: "Day of the Dead flowers honor the people we still talk about. Amorelia Luxury Floral Gifts delivers bouquets for your home ofrenda across Miami for November 1st and 2nd — premium roses hand-tied in the colors your family chose to remember.",
      es: "Las flores para Día de Muertos honran a quienes seguimos nombrando. Amorelia Luxury Floral Gifts entrega bouquets para tu ofrenda en casa por todo Miami el 1 y 2 de noviembre — rosa premium hecha a mano en los colores que tu familia eligió para recordar.",
    },
    sections: [
      {
  ...
  },
  {
    ...
    title: {
      en: "Graduation Flowers Miami | Bouquets Delivered to the Ceremony | Amorelia Luxury Floral Gifts",
      es: "Flores de Graduación Miami | Bouquets a Domicilio o a la Ceremonia | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Anniversary Flowers Miami | Red Roses & Custom Bouquets | Amorelia Luxury Floral Gifts",
      es: "Flores de Aniversario Miami | Rosas Rojas y Bouquets a Medida | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Get Well Flowers Miami | Hospital & Home Delivery | Amorelia Luxury Floral Gifts",
      es: "Flores para Recuperación Miami | Entrega a Hospital o Casa | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Romantic Flowers Miami | Love Roses Delivered Same-Day | Amorelia Luxury Floral Gifts",
      es: "Flores Románticas Miami | Rosas de Amor el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
    ...
    intro: {
      en: "Romantic flowers don't need a date on the calendar. Amorelia Luxury Floral Gifts hand-ties love bouquets of premium Ecuadorian red roses and delivers them same-day across Miami — the classic 100-rose statement, or a custom-color romantic bouquet in her exact palette. When it isn't Valentine's Day and isn't an anniversary, that's exactly when it lands hardest.",
      es: "Las flores románticas no necesitan una fecha en el calendario. Amorelia Luxury Floral Gifts monta a mano bouquets de amor con rosa roja premium ecuatoriana y los entrega el mismo día por Miami — el statement clásico de 100 rosas, o un bouquet romántico a color en su paleta exacta. Cuando no es San Valentín ni un aniversario es justo cuando más pega.",
    },
    sections: [
      {
  ...
  },
  {
    ...
    title: {
      en: "Thank You Flowers Miami | Same-Day Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Agradecimiento Miami | Bouquets el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Father's Day Flowers Miami | Bouquets for Dad Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores del Día del Padre Miami | Bouquets para Papá a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Thanksgiving Flowers Miami | Centerpieces & Roses Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Acción de Gracias Miami | Centros y Rosas a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Quinceañera Bouquet Miami | Custom Color Bouquets for 15s | Amorelia Luxury Floral Gifts",
      es: "Ramo de Quinceañera Miami | Bouquets a Medida para los 15 | Amorelia Luxury Floral Gifts",
    },
    description: {
    ...
    intro: {
      en: "A quinceañera bouquet should match her dress — not the floral shop's default. Amorelia Luxury Floral Gifts builds custom-color bouquets in Miami for the misa, the photo shoot and the reception: pinks, whites, peach, lavender, or whatever palette she picked for her day.",
      es: "Un ramo de quinceañera debe combinar con su vestido — no con lo que tenga la florería en stock. Amorelia Luxury Floral Gifts monta bouquets a color a medida en Miami para la misa, la sesión de fotos y la recepción: rosas, blancos, melocotón, lavanda o la paleta que ella eligió para su día.",
    },
    sections: [
      {
  ...
  },
  {
    ...
    title: {
      en: "Administrative Professionals Day Flowers Miami | Office Delivery | Amorelia Luxury Floral Gifts",
      es: "Flores Día de la Secretaria Miami | Entrega a la Oficina | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Boss's Day Flowers Miami | Office Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores Día del Jefe Miami | Bouquets a Domicilio en Oficina | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  // ----------- TIER 3 (footer + index, niche) -----------
  {
    ...
    title: {
      en: "Congratulations Flowers Miami | Same-Day Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Felicitación Miami | Bouquets el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Women's Day Flowers Miami | March 8 Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores Día de la Mujer Miami | Bouquets el 8 de Marzo a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "New Baby Flowers Miami | Hospital & Home Delivery | Amorelia Luxury Floral Gifts",
      es: "Flores para Recién Nacido Miami | Entrega a Hospital o Casa | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Just Because Flowers Miami | No-Occasion Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores Porque Sí Miami | Bouquets Sin Ocasión a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "I'm Sorry Flowers Miami | Apology Bouquets Delivered Same-Day | Amorelia Luxury Floral Gifts",
      es: "Flores para Pedir Perdón Miami | Bouquets de Disculpa el Mismo Día | Amorelia Luxury Floral Gifts",
    },
    description: {
    ...
    intro: {
      en: "I'm sorry flowers work when they arrive fast — an apology that shows up two days late lands worse than none. Amorelia Luxury Floral Gifts delivers same-day across Miami: hand-tied apology bouquets of premium roses, with a handwritten card in your own words. The gesture does half the work before you say anything.",
      es: "Las flores para pedir perdón funcionan cuando llegan rápido — una disculpa que aparece dos días tarde pega peor que ninguna. Amorelia Luxury Floral Gifts entrega el mismo día por Miami: bouquets de disculpa hechos a mano con rosa premium y una tarjeta escrita a mano con tus palabras. El gesto hace la mitad del trabajo antes de que digas nada.",
    },
    sections: [
      {
  ...
  },
  {
    ...
    title: {
      en: "New Year Flowers Miami | December 31 Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Año Nuevo Miami | Bouquets para el 31 de Diciembre | Amorelia Luxury Floral Gifts",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      en: "Easter Flowers Miami | Spring Bouquets Delivered | Amorelia Luxury Floral Gifts",
      es: "Flores de Semana Santa Miami | Bouquets de Primavera a Domicilio | Amorelia Luxury Floral Gifts",
    },
    description: {
