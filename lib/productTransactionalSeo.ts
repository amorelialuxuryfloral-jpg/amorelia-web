 ...
 *  - Amorelia-KW-EN-completo.md / Amorelia-KW-ES-completo.md
 *  - Amorelia-Keyword-Research.md
 *  - Amorelia-ColaLarga-Variantes-por-coleccion.md
 *
 ...
 * Amorelia-KW-EN-completo.md / Amorelia-Keyword-Research.md (red/white/pink/yellow/
 * black = 60,500; blue = 49,500). ES "rosas <color>" from
 * Amorelia-KW-ES-completo.md. purple/orange/green: the EN research lists the color
...
const buildEntry = (c: ColorCopy): TsrEntry => ({
  en: {
    ...
    body:
      ...
      `bouquet is hand-arranged the morning it ships. Same-day delivery up to 90 ` +
  ...
  es: {
    ...
    body:
      ...
      `cada ramo se monta a mano el día del envío. Flores a domicilio hasta 90 ` +
