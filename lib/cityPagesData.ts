...
export const cityPages: CityPage[] = [
  {
    ...
    intro: {
      en: "Sending roses to New York means timing them to a doorman building, an office tower with a strict mailroom, or a 4-flight East Village walk-up. Amorelia Luxury Floral Gifts ships from Miami via FedEx Express overnight to all five boroughs, packed in our insulated luxury box so the bouquet arrives cold and tight after a 1,280-mile flight.",
      es: "Mandar rosas a Nueva York implica coordinar con un portero, con la mailroom de una torre de oficinas o con un walk-up de cuatro pisos en el East Village. Amorelia Luxury Floral Gifts envía desde Miami por FedEx Express overnight a los cinco boroughs, empacadas en nuestra caja de lujo aislada para que el bouquet llegue frío y firme tras 1,280 millas.",
    },
    localTouch: {
