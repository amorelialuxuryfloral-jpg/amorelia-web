...
export interface RoomDecorPackage {
  ...
  /** Spanish SEO title/description for the /es twin (so the ES page's <title>
   *  and meta aren't served in English). Prefer these over the EN seoData. */
  seoTitleEs?: string;
...
export const roomDecorPackages: RoomDecorPackage[] = [
  {
    ...
    seoTitleEs: 'Love Bomb Miami | Decoración de Habitación Romántica | Amorelia Luxury Floral Gifts',
    seoDescriptionEs: 'Decoración romántica Love Bomb en Miami: flores premium, velas y montaje personalizado. Perfecto para aniversarios, San Valentín y propuestas. Reserva el mismo día.',
  ...
  },
  {
    ...
    seoTitleEs: 'Overly Romantic Miami | Decoración Romántica de Habitación | Amorelia Luxury Floral Gifts',
    seoDescriptionEs: 'Decoración Overly Romantic en Miami: montaje floral y decorativo de alto nivel para citas sorpresa, aniversarios y celebraciones especiales. Reserva el mismo día.',
    ...
    addons: [
      ...
      { label: 'Bouquet add-on Banner', labelEs: 'Banner adicional para el ramo', price: 0 },
    ],
    maxAddons: 1,
    freeDeliveryMiles: 10,
  },
  {
    ...
    seoTitleEs: 'Deluxe Love Package Miami | Decoración Romántica Completa | Amorelia Luxury Floral Gifts',
    seoDescriptionEs: 'La experiencia romántica más completa en Miami: transformación total con flores premium, velas, pétalos de rosa y decoración personalizada. Ideal para propuestas. Reserva el mismo día.',
