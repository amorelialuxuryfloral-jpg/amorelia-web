...
export const LONG_TAIL_SEO: Record<string, LongTailEntry> = {
  ...
  "color:red": {
    en: {
      ...
      sections: [
        ...
        {
          h2: "Roses for anniversaries, birthdays and last-minute gifts",
      ...
      altVariant: "Dozen red roses bouquet — Amorelia Luxury Floral Gifts Miami",
    },
    es: {
      intro:
      ...
      altVariant: "Ramo de rosas rojas naturales — Amorelia Luxury Floral Gifts Miami",
    },
  },
  ...
  "color:black": {
    en: {
      ...
      altVariant: "Black rose bouquet — Amorelia Luxury Floral Gifts Miami",
    },
    es: {
      intro:
  ...
  "color:purple": {
    en: {
      ...
      altVariant: "Bunch of purple roses — Amorelia Luxury Floral Gifts Miami",
    },
    es: {
      intro:
  ...
  "color:green": {
    en: {
      ...
      altVariant: "Green roses arrangement — Amorelia Luxury Floral Gifts Miami",
    },
    es: {
      intro:
  ...
  zodiac: {
    en: {
      ...
      closing: "Personalize the gesture with our {{0}}, a classic {{1}} or every variety of {{2}}. You can also read our full guides to {{3}} and {{4}}.",
      links: [
        { anchor: "flower of zodiac signs", to: "/bouquets/purple-roses" },
        { anchor: "rose bouquet", to: "/bouquets" },
        { anchor: "roses", to: "/bouquets" },
        { anchor: "flowers by zodiac sign", to: "/flowers-by-zodiac-sign" },
        { anchor: "birth flowers by month", to: "/birth-flowers-by-month" },
      ],
  ...
  "mothers-day": {
    en: {
      intro:
        "Make her day with Mother's Day flowers delivered to her door in Miami — fresh rose bouquets of 50 to 200 roses, hand-arranged for same-day delivery.",
      sections: [
        {
        ...
        {
          // Catalog = roses (48 rose fichas): no carnations/mums in the product
          // data, so the H2 talks about what Amorelia actually sells. "mothers day
          // roses delivery" = real keyword (6.6k, KEYWORD-RESEARCH-REAL.md).
          h2: "Mothers day roses delivery — 50 to 200 fresh roses",
          body: 'Our mothers day roses come as hand-tied bouquets of 50, 100, 150 or 200 stems, arranged the same morning they ship. Searching "flowers for mom on mother\'s day" the day before? We still deliver same-day in Miami.',
        },
      ],
